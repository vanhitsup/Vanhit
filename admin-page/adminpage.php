...
<head>
    ...
    <title> Dashboard - VanhITs.com</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Hi Admin !</h1>
                <p class="mb-4">Chào mừng bạn trở lại với trang Admin. Rất vui khi gặp lại bạn !</p>
