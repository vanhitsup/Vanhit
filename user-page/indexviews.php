...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="indexviews.php" style="font-weight: bold;font-size:30px;color:white">VietAnhITs.com</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="../login/demologin.php" style="font-weight: bold">Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" >|</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../login/demoregister.php" style="font-weight: bold">Create Account</a>
                </li>
            </ul>
        </div>
    </div>
